...
import FeatureToolip from './feature-tooltip'
...
export default function ExportBookmarks() {
  ...
  //     exportAsHTML(data, `bookmarkit-bookmarks-${formatDate(new Date(), dateOptions)}`)
  //   } catch (errr) {
  ...
  //     exportAsCSV(data, `bookmarkit-bookmarks-${formatDate(new Date(), dateOptions)}`)
  //   } catch (errr) {
  //     toast.error('Unable to export bookmarks, try again.')
  //   } finally {
  //     setLoadingCSV(false)

...
export default function TermsPage() {
  return (
    <main className='w-full flex flex-col px-2 my-6 mt-12'>
      ...
      <p className='my-1 leading-7'>
        ...
        intellectual property rights related to it, still belong to Bookmark It. under their
        licenses provide.
      </p>
      <p className='my-1 leading-7'>
        Bookmark It. (&quot;bmrk.cc&quot;, &quot;we&quot;, &quot;us&quot;, and/or &quot;our&quot;)
        built the Bookmark It. is committed to ensuring that the app is as useful and efficient as
      ...
      <p className='my-1 leading-7'>
        The Bookmark It. app stores and processes personal data that you have provided to us, to
        ...
        programs, compromise your phone’s security features and it could mean that the Bookmark It.
      ...
      <p className='my-1 leading-7'>
        You should be aware that there are certain things that bmrk.cc will not take responsibility
        ...
        bmrk.cc cannot take responsibility for the app not working at full functionality if you
      ...
      <p className='my-1 leading-7'>
        Along the same lines, bmrk.cc cannot always take responsibility for the way you use the app
        i.e. You need to make sure that your device stays charged – if it runs out of battery and
        you can’t turn it on to avail the Service, bmrk.cc cannot accept responsibility.
      </p>
      <p className='my-1 leading-7'>
        With respect to bmrk.cc’s responsibility for your use of the app, when you’re using the app,
        ...
        can make it available to you. bmrk.cc accepts no liability for any loss, direct or indirect,
      ...
      <p className='my-1 leading-7'>
        ...
        to keep using the app. bmrk.cc does not promise that it will always update the app so that
      ...
      <p className='my-1 leading-7'>
        Bookmark It. may update our Terms and Conditions from time to time. Thus, you are advised to

  ...
  return (
    <main className='w-full flex flex-col px-2 my-6 mt-12'>
      ...
      <p className='my-1 leading-7'>
        ...
        built the Bookmark It. app as a Freemium app. This SERVICE is provided at no cost and is
      ...
      <p className='my-1 leading-7'>
        ...
        which are accessible at Bookmark It. unless otherwise defined in this Privacy Policy.
      </p>

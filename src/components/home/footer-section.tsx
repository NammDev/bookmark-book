...
export default function FooterSection() {
  return (
    <div className={cn('w-full sm:max-w-4xl mt-28 p-4 flex flex-col sm:flex-row justify-between')}>
      <div className='flex flex-col'>
        ...
        <p className='text-muted-foreground mt-4 text-sm'>Organize, Discover, and Personalize.</p>
      </div>

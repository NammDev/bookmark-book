    ...
    <TooltipProvider>
      <div className='mx-auto my-8 mt-10 flex flex-col items-center'>
        <h2 className='mt-4 mb-0 text-3xl font-extrabold text-center tracking-[-0.03em] text-primary sm:text-4xl sm:leading-[3.5rem]'>
          <span className='text-neutral-950 bg-clip-text mt-1 inline-flex'>Our Pricing Plans</span>
        </h2>
        ...
        <div className='mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4'>
          <div className='sm:min-w-[360px] max-w-full rounded-2xl border border-input bg-white shadow-md text-left sm:mr-8 text-primary'>
            <div className='px-5 p-5'>
              ...
              <p className='text-muted-foreground mt-1.5'>Free forever with limits.</p>
              <div className='my-4'>
              ...
              <div className='flex flex-col gap-2.5 tracking-wide'>
                <p className='text-gray-700 flex items-center font-medium'>What{"'"}s included:</p>
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-primary' /> {plans.free.limit.bookmarks}{' '}
                  bookmarks/mo{' '}
                  <PlanTooltip
                ...
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-primary' /> {plans.free.limit.tags} tags
                </p>
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-primary' /> {plans.free.limit.favorites} favorite
                  bookmarks
                </p>
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-primary' />
                ...
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-primary' /> Theme Customizations
                </p>
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-primary' /> One-Click Browser Extensions
                </p>
              </div>
          ...
          <div className='min-w-[330px] bg-gradient-to-r from-sky-0 to-sky-50 via-white rounded-2xl border-2 border-sky-100 bg-white shadow-md text-left sm:mr-8 text-primary'>
            <div className='px-5 p-5'>
              ...
              <p className='text-muted-foreground mt-1.5'>Get more out of pro plan</p>
              <div className='my-4'>
                <p className='text-4xl tabular-nums font-semibold text-primary'>
                  ${planYearly ? plans.pro.pricing.yearly : plans.pro.pricing.monthly}{' '}
              ...
              <div className='flex flex-col gap-2.5 tracking-wide'>
                ...
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-blue-600' /> {plans.pro.limit.bookmarks}{' '}
                  bookmarks/mo{' '}
                  <PlanTooltip
                    className='!ml-0.5 relative -top-1'
                    text={messages.usageLimitRenewal}
                ...
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-blue-600' /> {plans.pro.limit.tags} tags
                </p>
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-blue-600' /> {plans.pro.limit.favorites} favorite
                  bookmarks
                </p>
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-blue-600' />
                ...
                <p className='text-gray-600 flex items-center font-normal'>
                  <PriceCheckIcon className='text-blue-600' /> Export bookmarks as CSV/HTML
                </p>
                <p className='text-gray-600 flex items-center font-normal'>

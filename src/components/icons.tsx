...
export default function Loader({ className = '' }: { className?: string }) {
  return (
    <svg
      className={cn(`h-5 w-5 text-black dark:text-white loading-spinner`, className)}
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
      viewBox='0 0 24 24'
    >
...
export const EmptyFavoriteState = ({ className }: { className?: string }) => {
  return (
    <div className='flex flex-col h-80 justify-center items-center'>
      ...
      <h3 className='text-primary mt-3 tracking-wide font-medium'>No favorites yet!</h3>
      <p className='mt-1 text-sm text-muted-foreground text-center'>
...
export const EmptyTagState = ({ className, tagName }: { className?: string; tagName: string }) => {
  return (
    <div className={`flex flex-col h-80 justify-center items-center px-4 text-center ${className}`}>
...
export const EmptyBookmarkSharedState = ({ className }: { className?: string }) => {
  return (
    <div className='flex flex-col h-80 justify-center items-center'>
      <svg
        className={cn('text-primary w-10 h-10', className)}
      ...
      <h3 className='text-primary mt-3 tracking-wide font-medium'>No Bookmarks</h3>
      <p className='mt-1 text-sm text-muted-foreground text-center'>
...
export const RateLimitState = ({ className }: { className?: string }) => {
  return (
    <div className='flex flex-col h-80 justify-center items-center'>
      ...
      <h3 className='text-primary mt-3 tracking-wide font-medium'>Hold on, too many requests!</h3>
      <p className='mt-1 text-sm text-muted-foreground text-center'>
...
export const NotFoundIcon = ({ className }: { className?: string }) => {
  return (
    <div className='flex flex-col h-80 justify-center items-center'>
      <h3 className='text-primary mt-3 tracking-wide text-xl font-medium'>404</h3>
      <p className='mt-1 text-sm text-muted-foreground text-center'>
...
export const FavIcon = ({ className, isActive }: { className?: string; isActive?: boolean }) => {
  if (isActive) {
    return (
      <svg
        className={className}
...
export const SearchIcon = ({ className, isActive }: { className?: string; isActive?: boolean }) => {
  if (isActive) {
    return (
      <svg
        className={className}
...
export const TagsIcon = ({ className, isActive }: { className?: string; isActive?: boolean }) => {
  if (isActive) {
    return (
      <svg
        className={className}

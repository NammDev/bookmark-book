...
export default function PaymentModal({ open, onHide, onClick }: PaymentModalType) {
  const [type, setType] = useState('yearly')
  const planPrice = type === 'yearly' ? plans.pro.pricing.yearly : plans.pro.pricing.monthly
        ...
        <div className='px-4 flex items-center flex-col bg-neutral-50 dark:bg-neutral-900 rounded-br-xl rounded-bl-xl'>
          ...
          <div className='flex flex-col sm:w-[350px] w-full items-star gap-3 justify-center my-4'>
            <div className='text-gray-700 gap-2 dark:text-white text-primary flex items-center font-medium'>
              ...
              <Badge variant='outline' className='py-1 mt-2 inline-flex items-center'>
            ...
            <div className='dark:text-white text-primary mt-2 flex items-center font-normal'>
              ...
              <PlanTooltip className='!ml-1 relative -top-1' text={messages.usageLimitRenewal} />
            </div>
